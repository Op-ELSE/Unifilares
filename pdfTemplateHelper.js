 ...
 * @param {Object} data  // keys: systemVoltage, upstreamBreaker, … etc.
...
async function populateTemplate(data, eppImageBase64) {
  ...
  // Text fields (example – add the rest similarly)
  const textMap = {
  ...
  for (const [key, value] of Object.entries(textMap)) {
    ...
    const drawOptions = { x: fx, y: fy, size: 12, color };
